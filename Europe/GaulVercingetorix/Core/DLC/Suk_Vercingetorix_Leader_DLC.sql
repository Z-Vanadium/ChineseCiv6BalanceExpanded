...
VALUES	('LEADER_SUK_VERCINGETORIX_DLC',		'LEADER_SUK_VERCINGETORIX_NEUTRAL',		'LEADER_SUK_VERCINGETORIX__BACKGROUND',		0);
--==========================================================================================================================
-- LEADERS
--==========================================================================================================================
-- Types
...
INSERT INTO Types
		(Type,									Kind)
VALUES	('LEADER_SUK_VERCINGETORIX_DLC',		'KIND_LEADER');
-------------------------------------
-- Leaders
-------------------------------------
INSERT INTO Leaders
		(LeaderType,							Name,											InheritFrom,		SceneLayers)
VALUES	('LEADER_SUK_VERCINGETORIX_DLC',		'LOC_LEADER_SUK_VERCINGETORIX_DLC_NAME',		'LEADER_DEFAULT',	4);
-------------------------------------
-- LeaderQuotes
-------------------------------------
INSERT INTO LeaderQuotes
		(LeaderType,							Quote)
VALUES	('LEADER_SUK_VERCINGETORIX_DLC',		'LOC_PEDIA_LEADERS_PAGE_SUK_VERCINGETORIX_DLC_QUOTE');
-------------------------------------
-- LeaderTraits
-------------------------------------
INSERT INTO LeaderTraits
		(LeaderType,							TraitType)
VALUES	('LEADER_SUK_VERCINGETORIX_DLC',		'TRAIT_LEADER_SUK_GALLIC_WAR');
-------------------------------------
-- FavoredReligions
-------------------------------------
INSERT OR REPLACE INTO FavoredReligions
		(LeaderType,						ReligionType)
SELECT	'LEADER_SUK_VERCINGETORIX_DLC',		'RELIGION_DRUIDISM'
...
VALUES
	(
		'TRAIT_LEADER_SUK_GALLIC_WAR',
		'LOC_TRAIT_LEADER_SUK_GALLIC_WAR_NAME',
		(SELECT CASE
			WHEN EXISTS (SELECT * FROM Improvements WHERE ImprovementType = 'IMPROVEMENT_SUK_DUNON')
			THEN 'LOC_TRAIT_LEADER_SUK_GALLIC_WAR_DESCRIPTION'
			ELSE 'LOC_TRAIT_LEADER_SUK_GALLIC_WAR_DESCRIPTION_DLC'
			END Description
		)
	);
--==========================================================================================================================
...
INSERT INTO RequirementSetRequirements
		(RequirementSetId,												RequirementId)
SELECT	'SUK_GALLIC_WAR_FREE_WALLS_DISTRICTS_REQUIREMENTS',				'REQUIRES_CITY_HAS_INDUSTRIAL_ZONE'
WHERE NOT EXISTS (SELECT * FROM Improvements WHERE ImprovementType = 'IMPROVEMENT_SUK_DUNON');
-------------------------------------
-- Requirements
-------------------------------------
INSERT INTO Requirements
...
INSERT INTO RequirementArguments
		(RequirementId, 								Name,						Value)
VALUES	('REQUIRES_PLAYER_IS_SUK_VERCINGETORIX', 		'LeaderType',				'LEADER_SUK_VERCINGETORIX_DLC');
-------------------------------------
...
SELECT	'IMPROVEMENT_SUK_DUNON', 				'SUK_GALLIC_WAR_FREE_WALLS'
WHERE EXISTS (SELECT * FROM Improvements WHERE ImprovementType = 'IMPROVEMENT_SUK_DUNON');
--==========================================================================================================================
-- AGENDAS
-- King Over Warriors
--==========================================================================================================================
...
VALUES	('LEADER_SUK_VERCINGETORIX_DLC',				'AGENDA_SUK_KING_OVER_WARRIORS');
-------------------------------------
-- Agendas
-------------------------------------
INSERT INTO Agendas
...
VALUES	('AGENDA_SUK_KING_OVER_WARRIORS_KUDOS',			'InitialValue',					8),
		('AGENDA_SUK_KING_OVER_WARRIORS_KUDOS',			'StatementKey',					'LOC_DIPLO_KUDO_EXIT_LEADER_SUK_VERCINGETORIX_DLC_ANY'),
		('AGENDA_SUK_KING_OVER_WARRIORS_KUDOS',			'SimpleModifierDescription',	'LOC_DIPLO_MODIFIER_SUK_KING_OVER_WARRIORS_KUDO'),

		('AGENDA_SUK_KING_OVER_WARRIORS_WARNING',		'InitialValue',					-12),
		('AGENDA_SUK_KING_OVER_WARRIORS_WARNING',		'StatementKey',					'LOC_DIPLO_WARNING_EXIT_LEADER_SUK_VERCINGETORIX_DLC_ANY'),
		('AGENDA_SUK_KING_OVER_WARRIORS_WARNING',		'SimpleModifierDescription',	'LOC_DIPLO_MODIFIER_SUK_KING_OVER_WARRIORS_WARNING');
-------------------------------------
-- ModifierStrings
-------------------------------------
INSERT INTO ModifierStrings
...
VALUES  ('LEADER_SUK_VERCINGETORIX_DLC',		'CIVILIZATION_GAUL',		'LOC_CITY_NAME_BIBRACTE');
--==========================================================================================================================
--==========================================================================================================================