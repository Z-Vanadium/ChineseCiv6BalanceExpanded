...
INSERT INTO Types
			(Type,							Kind			)
VALUES		('TRAIT_AGENDA_CYH_JAN_ZIZKA',		'KIND_TRAIT'	);
...
VALUES 		('AGENDA_CYH_JAN_ZIZKA',	'LOC_AGENDA_CYH_JAN_ZIZKA_NAME',	'LOC_AGENDA_CYH_JAN_ZIZKA_DESCRIPTION'		);
...
VALUES		('TRAIT_AGENDA_CYH_JAN_ZIZKA',		'LOC_AGENDA_AGENDA_CYH_JAN_ZIZKA_NAME',	'LOC_AGENDA_AGENDA_CYH_JAN_ZIZKA_DESCRIPTION'		);
...
VALUES 		('AGENDA_CYH_JAN_ZIZKA',	'TRAIT_AGENDA_CYH_JAN_ZIZKA'	);
...
VALUES 		('LEADER_CYH_JAN_ZIZKA',	'AGENDA_CYH_JAN_ZIZKA'		);
...
INSERT INTO ExclusiveAgendas
			(AgendaOne,				AgendaTwo					)
VALUES 		('AGENDA_CYH_JAN_ZIZKA',	'AGENDA_MONEY_GRUBBER'		);
...
VALUES		('TRAIT_AGENDA_CYH_JAN_ZIZKA',		'AGENDA_MODIFIER_CYH_JAN_ZIZKA_UNHAPPY'	),
			('TRAIT_AGENDA_CYH_JAN_ZIZKA',		'AGENDA_MODIFIER_CYH_JAN_ZIZKA_HAPPY'		);
...
VALUES		('AGENDA_MODIFIER_CYH_JAN_ZIZKA_UNHAPPY',		'MODIFIER_PLAYER_DIPLOMACY_SIMPLE_MODIFIER',	'REQSET_CYH_JAN_ZIZKA_UNHAPPY'		),
			('AGENDA_MODIFIER_CYH_JAN_ZIZKA_HAPPY',		'MODIFIER_PLAYER_DIPLOMACY_SIMPLE_MODIFIER',	'REQSET_CYH_JAN_ZIZKA_HAPPY'		);
...
VALUES		('AGENDA_MODIFIER_CYH_JAN_ZIZKA_UNHAPPY',		'Sample',	'LOC_TOOLTIP_SAMPLE_DIPLOMACY_ALL'	),
			('AGENDA_MODIFIER_CYH_JAN_ZIZKA_HAPPY',		'Sample',	'LOC_TOOLTIP_SAMPLE_DIPLOMACY_ALL'	);
...
VALUES		('AGENDA_MODIFIER_CYH_JAN_ZIZKA_UNHAPPY',	'InitialValue',					-5													),
			('AGENDA_MODIFIER_CYH_JAN_ZIZKA_UNHAPPY',	'IncrementValue',				-1													),
			('AGENDA_MODIFIER_CYH_JAN_ZIZKA_UNHAPPY',	'IncrementTurns',				-10													),
			('AGENDA_MODIFIER_CYH_JAN_ZIZKA_UNHAPPY',	'MaxValue',						-25													),
			('AGENDA_MODIFIER_CYH_JAN_ZIZKA_UNHAPPY',	'StatementKey',					'LOC_DIPLO_WARNING_LEADER_CYH_JAN_ZIZKA_REASON_ANY'	),
			('AGENDA_MODIFIER_CYH_JAN_ZIZKA_UNHAPPY',	'SimpleModifierDescription',	'LOC_DIPLO_MODIFIER_CYH_JAN_ZIZKA_UNHAPPY'				),
	
			('AGENDA_MODIFIER_CYH_JAN_ZIZKA_HAPPY',	'InitialValue',					5													),
			('AGENDA_MODIFIER_CYH_JAN_ZIZKA_HAPPY',	'IncrementValue',				1													),
			('AGENDA_MODIFIER_CYH_JAN_ZIZKA_HAPPY',	'IncrementTurns',				10													),
			('AGENDA_MODIFIER_CYH_JAN_ZIZKA_HAPPY',	'MaxValue',						12													),
			('AGENDA_MODIFIER_CYH_JAN_ZIZKA_HAPPY',	'StatementKey',					'LOC_DIPLO_KUDO_LEADER_CYH_JAN_ZIZKA_REASON_ANY'		),
			('AGENDA_MODIFIER_CYH_JAN_ZIZKA_HAPPY',	'SimpleModifierDescription',	'LOC_DIPLO_MODIFIER_CYH_JAN_ZIZKA_HAPPY'				);
...
VALUES		('REQSET_CYH_JAN_ZIZKA_UNHAPPY',	'REQUIREMENTSET_TEST_ALL'	),
			('REQSET_CYH_JAN_ZIZKA_HAPPY',		'REQUIREMENTSET_TEST_ALL'	);
...
VALUES		('REQSET_CYH_JAN_ZIZKA_UNHAPPY',	'REQUIRES_MAJOR_CIV_OPPONENT'		),
			('REQSET_CYH_JAN_ZIZKA_UNHAPPY',	'REQUIRES_MET_10_TURNS_AGO'			),
			('REQSET_CYH_JAN_ZIZKA_UNHAPPY',	'REQUIRES_HAS_HIGH_FAITH'			),
			('REQSET_CYH_JAN_ZIZKA_UNHAPPY',	'REQUIRES_HAS_HIGH_INCOME'			),
			('REQSET_CYH_JAN_ZIZKA_UNHAPPY',	'REQUIRES_HAS_LOW_HAPPINESS'			),
			('REQSET_CYH_JAN_ZIZKA_HAPPY',		'REQUIRES_MAJOR_CIV_OPPONENT'		),
			('REQSET_CYH_JAN_ZIZKA_HAPPY',		'REQUIRES_MET_10_TURNS_AGO'			),
			('REQSET_CYH_JAN_ZIZKA_HAPPY',	'REQUIRES_HAS_HIGH_FAITH'			),
			('REQSET_CYH_JAN_ZIZKA_HAPPY',	'REQUIRES_HAS_HIGH_INCOME'			),
			('REQSET_CYH_JAN_ZIZKA_HAPPY',	'REQUIRES_HAS_HIGH_HAPPINESS'			);
