...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/MC_MasterTemplate\Textures\LEADER_CYH_JAN_ZIZKA_BACKGROUND.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>2098241866</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LEADER_CYH_JAN_ZIZKA_BACKGROUND.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEADER_CYH_JAN_ZIZKA_BACKGROUND"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
