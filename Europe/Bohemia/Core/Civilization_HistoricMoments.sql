...
VALUES	('MOMENT_ILLUSTRATION_UNIQUE_UNIT',			'MOMENT_DATA_UNIT',				'UNIT_CYH_WAGON_FORT',				'WagonFortHistoricMoment.dds'		),
		('MOMENT_ILLUSTRATION_UNIQUE_DISTRICT',	'MOMENT_DATA_DISTRICT',		'DISTRICT_CYH_ROYAL_MINT',		'RoyalMintHistoricMoment.dds'	);
